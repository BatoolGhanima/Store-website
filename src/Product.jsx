...
const Product = ({images,title,category,description,price}) => {
    return (
      ...
      <div className=' flesx flex-row items-center m-4 p-6 border border-gray-200  border-[2px] rounded-lg shadow-lg hover:shadow-xl h-[800px] overflow-auto'> 
  ...
  <p className='font-bold text-[34px]  text-center text-[#132745] '> {price} $ </p>
           {/* <p className='bg-custom-gradient border-spacing-2  border-red-100 text-[30px] text-[#304463] font-semibold  w-full text-center h-16 rounded p-2 mt-6'>{category}</p> */}
            </div>
        </div>
  )
}
